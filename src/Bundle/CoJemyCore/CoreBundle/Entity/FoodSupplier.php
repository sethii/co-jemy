...
class FoodSupplier
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Bundle\CoJemyCore\CoreBundle\Entity\MenuItem", mappedBy="foodSupplier", cascade={"remove"})
     */
    private $menuItems;
     ...
     * Add menuItem
     *
     * @param \Bundle\CoJemyCore\CoreBundle\Entity\MenuItem $menuItem
     *
     * @return FoodSupplier
     */
    public function addMenuItem(\Bundle\CoJemyCore\CoreBundle\Entity\MenuItem $menuItem)
    {
     ...
     * @param \Bundle\CoJemyCore\CoreBundle\Entity\MenuItem $menuItem
     */
    public function removeMenuItem(\Bundle\CoJemyCore\CoreBundle\Entity\MenuItem $menuItem)
    {
